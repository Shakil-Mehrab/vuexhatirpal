...
<div class="login-box">
  ...
  <div class="login-box-body">
    <p class="login-box-msg"><span style="font-size:25px;color:orange">Sign In As User</span></p>
    ...
    <a href="/register" class="text-center"><span style="font-size:20px">Create a New Account</span></a>
