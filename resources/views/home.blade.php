...
<main class="main">
    ...
    <div class="featured-products-section carousel-section">
        <div class="container">
            <h2 class="h3 title mb-4 text-center">Offered Products</h2>

            <div class="featured-products owl-carousel owl-theme">
            @php
            use App\Model\Product_discount;
                $products=Product_discount::orderBy('id','desc')->get();
            @endphp
            @forelse($products as $product)
                <div class="product">
                    <figure class="product-image-container">
                        <a href="/user/product/show/{{$product->product->id}}" class="product-image">
                            <img src="storage/{{$product->product->cover_img}}" alt="product">
                        </a>
                        <a href="/user/product/quick/show/{{$product->product->id}}" class="btn-quickview">Quickview</a>
                    </figure>
                    <div class="product-details">
                        <div class="ratings-container">
                            <div class="product-ratings">
                                <span class="ratings" style="width:{{100/5*$product->product->rating}}%"></span><!-- End .ratings -->
                            </div><!-- End .product-ratings -->
                        </div><!-- End .product-container -->
                        <h2 class="product-title">
                            <a href="/user/product/show/{{$product->id}}">{{$product->product->name}}</a>
                        </h2>
                        <div class="price-box">
                            <span class="old-price">${{$product->product->price}}</span>
                            <span class="product-price">${{$product->product->price*$product->discount->discount}}</span>
                        </div><!-- End .price-box -->
    ...
    <div class="featured-products-section carousel-section">
        <div class="container">
            <h2 class="h3 title mb-4 text-center">Womens Fashion</h2>
    ...
    <div class="featured-products-section carousel-section">
        <div class="container">
            <h2 class="h3 title mb-4 text-center">Jewelry</h2>
    ...
    <div class="featured-products-section carousel-section">
        <div class="container">
            <h2 class="h3 title mb-4 text-center">Electronics</h2>
