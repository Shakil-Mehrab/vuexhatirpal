                ...
                <div class="dropdown cart-dropdown">
                    ...
                    <div class="dropdown-menu" >
                        <div class="dropdownmenu-wrapper">
                            ...
                            @forelse($carts as $cart)
                                <div class="product">
                                    <div class="product-details">
                                        ...
                                        <span class="cart-product-info" style="display:flex">
                                            <span class="cart-product-qty">{{$cart->quantity}} </span>
                                            x <img src="porto/images/taka.png" style='width:12px;height:18px' alt="banner">{{$cart->price}}
                                        </span>
                            ...
                            <div class="dropdown-cart-total">
                                <span>Total</span>
                                <span class="cart-total-price" style="display:flex">
                                    <img src="porto/images/taka.png" style='width:20px;height:24px' alt="banner">{{Cart::getTotal()}}
                                </span>
                            </div>
                        </div><!-- End .dropdownmenu-wrapper -->
                    </div><!-- End .dropdown-menu -->
        ...
        <div class="container">
            <nav class="main-nav">
                <ul class="menu sf-arrows">
                    ...
                    @if(!empty($shop))
                        @if($shop->is_active==1)
                             <li class="float-right"><a href="/admin"><i class="fas fa-plus-square"></i> Create Product</a></li>
                        @else
                        <li class="float-right"><a href="#" style="color: red"><i class="fas fa-envelope-square"></i> Wait for Shop Confirmation</a></li>
                        @endif
                        @else
                        <li class="float-right"><a href="/user/shops/create"><i class="fas fa-plus-square"></i> Create Shop</a></li>
                    @endif
                </ul>
            </nav>
