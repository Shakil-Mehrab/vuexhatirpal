        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><router-link to="/admin/all/product">Product</router-link></li>
            ...
            <div class="card card-primary">
              ...
              <form role="form"  @submit.prevent="editProduct()">
                  <div class="card-body">
		            ...
		            <div class="row">
		                <div class="form-group col-lg-4 col-md-4 col-sm-12">
		                    <label for="extra_price" class="control-label">Extra Price</label>
		                    <input type="text" name="extra_price" id="extra_price" class="form-control" placeholder="Extra Price (Tk)"  v-model="form.extra_price" :class="{ 'is-invalid': form.errors.has('extra_price') }">
		                    <has-error :form="form" field="extra_price"></has-error>
		                </div>
		                 <div class="form-group col-lg-4 col-md-4 col-sm-12">
		                    <label for="vat" class="control-label">Vat</label>
		                    <input type="text" name="vat" id="vat" class="form-control" placeholder="Vat"   v-model="form.vat" :class="{'is-invalid': form.errors.has('vat') }">
		                    <has-error :form="form" field="vat"></has-error>
		                 </div>
		                 <div class="form-group col-lg-4 col-md-4 col-sm-12">
		                    <label for="position" class="control-label">Position</label>
		                     <select class="form-control" :class="{ 'is-invalid': form.errors.has('position') }" v-model="form.position">
	                            <option disabled value="">Select One</option>
                ...
                <div class="card-footer">
                	<div class="row">
		                ...
		                <div class="form-group col-lg-4 col-md-4 col-sm-4" >
		                 ...
		                 <div class="form-group col-lg-4 col-md-4 col-sm-4" >
		                   <router-link :to="`/edit/product/image/${this.$route.params.id}`"> <button class="btn btn-primary form-control"> Edit Image</button></router-link>
		                </div>
	                </div>
                </div>
              </form>
...
<script>
	export default{
		...
		mounted(){
			...
			axios.get(`admin/product/${this.$route.params.id}/edit`)
		...
		methods:{
		    editProduct(){
		      	this.form.post(`admin/product/update/${this.$route.params.id}`)
		      	.then((response)=>{
