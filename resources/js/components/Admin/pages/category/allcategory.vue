          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <table id="example2" class="table table-bordered table-hover">
                ...
                <tbody>
                <tr v-for="category in getAdminCategory.data">
              ...
              <div style="margin-left:40%"><br>
                <pagination :data="getAdminCategory" v-on:pagination-change-page="showAdminCategory"></pagination>
              </div>
            </div>
          </div>
        </div>
...
<script>
  export default{
    ...
    methods:{
      showAdminCategory(page){
        if(typeof page==='undefined'){page=1;}
        this.$store.dispatch("showAdminCategory",page)
      },
      deleteCategory(id){
      ...
      deleteSelected(){
          ...
          axios.get('/admin/category/delete/'+this.categoryItem)
           .then(()=>{
             this.categoryItem = []
             this.$store.dispatch("showAdminCategory")
             Toast.fire({
        ...
        selectAll(){
          if(this.all_select==false){
              ...
              for(var category in this.getAdminCategory.data){
                  this.categoryItem.push(this.getAdminCategory.data[category].id)
              }
          }else{
      ...
      RealSearch:_.debounce(function () {
        ...
        this.$store.dispatch('showSearchAdminCategory',this.keyword);
      },1000)
    }
  };
</script>
