	          ...
	          <div class="col-md-8">
	            <div class="card card-primary">
	              <div class="card-header">
	                <h3 class="card-title">Header Add</h3>
	              </div>
...
<script>
	export default{
		...
		methods:{
	        ...
	        addCountry(){
	        	console.log(this.form.heading);
	        	this.form.post('/admin/header')
	        	.then((response)=>{this.$router.push('/admin/all/header')
	            Toast.fire({
	              icon: 'success',
	              title: 'Header Added Successfully!'
	            })
	        })
	        	.catch(()=>{})
	        }
