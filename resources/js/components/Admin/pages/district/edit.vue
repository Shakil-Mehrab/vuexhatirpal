        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><router-link to="/admin/all/district">District</router-link></li>
                ...
                <div class="card-body">
                    ...
                    <label for="city_id">City</label>
                   	<select class="form-control"   :class="{ 'is-invalid': form.errors.has('city_id') }" v-model="form.city_id">
                          ...
                          <option :value="cat.id" v-for="cat in getallCategory">{{cat.name}} ({{cat.country.name}})</option>
                      </select>
...
<script>
    ...
    mounted(){
      ...
      axios.get(`admin/district/${this.$route.params.id}/edit`)
      .then((response)=>{
	...
	methods:{
      ...
      updateCategory(){
        this.form.post(`admin/district/update/${this.$route.params.id}`)
        .then((response)=>{
          Toast.fire({
            icon: 'success',
