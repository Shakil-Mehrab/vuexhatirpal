              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <table id="example2" class="table table-bordered table-hover">
                    ...
                    <tbody>
                    <tr v-for="category in getAdminCountry.data">
                  ...
                  <div style="margin-left:40%"><br>
                    <pagination :data="getAdminCountry" v-on:pagination-change-page="showAdminCountry"></pagination>
                  </div>
                </div>
              </div>
            </div>
...
export default{
    ...
    methods:{
      showAdminCountry(page){
        if(typeof page==='undefined'){page=1;}
        return this.$store.dispatch("showAdminCountry",page)
      },
      deleteProduct(id){
      ...
      deleteSelected(){
       ...
       //console.log(this.select)
        if(this.select=='delete'){
          ...
          axios.get('/admin/country/delete/'+this.categoryItem)
           .then(()=>{
             this.categoryItem = []
             this.$store.dispatch("showAdminCountry")
             Toast.fire({
      ...
      selectAll(){
        if(this.all_select==false){
          ...
          for(var category in this.getAdminCountry.data){
            this.categoryItem.push(this.getAdminCountry.data[category].id)
          } 
        }else{
