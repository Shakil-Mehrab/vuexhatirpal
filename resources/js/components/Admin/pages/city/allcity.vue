              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <table id="example2" class="table table-bordered table-hover">
                    ...
                    <tbody>
                    <tr v-for="category in getAdminCity.data">
                  ...
                  <div style="margin-left:40%"><br>
                    <pagination :data="getAdminCity" v-on:pagination-change-page="showAdminCity"></pagination>
                  </div>
                </div>
              </div>
            </div>
...
export default{
    ...
    methods:{
      showAdminCity(page){
        ...
        this.$store.dispatch("showAdminCity",page)
      },
      deleteProduct(id){
      ...
      deleteSelected(){
       ...
       //console.log(this.select)
        if(this.select=='delete'){
          ...
          axios.get('/admin/city/delete/'+this.categoryItem)
           .then(()=>{
             this.categoryItem = []
             this.$store.dispatch("showAdminCity")
             Toast.fire({
      ...
      selectAll(){
        if(this.all_select==false){
          ...
          for(var category in this.getAdminCity.data){
            this.categoryItem.push(this.getAdminCity.data[category].id)
          } 
        }else{
      ...
      RealSearch:_.debounce(function(){
        ...
        this.$store.dispatch('showSearchAdminCity',this.keyword);
      },1000)
    },
};
</script>
