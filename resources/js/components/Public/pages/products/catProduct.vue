                ...
                <div class="shop-sidebar mr-50">
                    ...
                    <div class="sidebar-widget mb-45">
                        ...
                        <div class="sidebar-categories">
                            <ul>
                                <li v-for="cat in getAllCategory" :Key="cat.id" v-if="cat.id==1"><a href="#">{{cat.name}} <span>4</span></a>
                                    <ul>
                                        <li v-for="child in cat.children" :Key="child.id"><a href="#">{{child.name}} <span>4</span></a>
                                        <ul>
                                             <li v-for="cl in child.children" :Key="cl.id"><a href="#">{{cl.name}} <span>4</span></a></li>
                                        </ul>
                                        </li>
                                    </ul>
                                </li>
                ...
                <div class="shop-product-wrapper res-xl res-xl-btn">
                    <div class="shop-bar-area">
                        <div class="shop-bar pb-60">
                            <div class="shop-found-selector">
                                <div class="shop-found">
                                    <p><span>{{getAllCategoryProduct.length}}</span> Product Found of <span></span></p>
                                </div>
                        ...
                        <div class="shop-product-content tab-content">
                            <div class="row" style="margin:25%" v-if="getDiscountProduct==''">
                                <img src="storage/default/loading.gif">
                            </div>
                            <div id="grid-sidebar1" class="tab-pane fade active show">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-xl-3" v-for="product in getAllCategoryProduct" :key="product.id">
                                        <div class="product-wrapper mb-30">
                                            <div class="product-img">
                                                ...
                                                <div class="product-action">
                                                    <a @click.prevent="addToWish(product.id)" class="animate-left" title="Wishlist" href="">
                            ...
                            <div id="grid-sidebar2" class="tab-pane fade">
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 col-xl-6" v-for="product in getAllCategoryProduct" :key="product.id">
...
export default {
    ...
    computed:{
        ...
        return this.$store.getters.getAllCategoryProduct
        },
    },
     methods:{
        showAllCategory(){
        ...
        this.$store.dispatch('showAllCategoryProduct',this.$route.params.id)
        },
        addToCart(id){
        console.log(id)
      ...
      .catch(()=>{})
        ...
        RealSearch(){
            console.log(this.keyword)
             this.$store.dispatch('showSearchRealByCatId',this.$route.params.id+'?s='+this.keyword)
        },
    },
    mounted(){
      this.showAllCategoryProduct();
