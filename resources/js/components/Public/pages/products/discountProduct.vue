                    ...
                    <div class="shop-bar-area">
                        <div class="shop-bar pb-60">
                            <div class="shop-found-selector">
                                <div class="shop-found">
                                    <p><span>{{getDiscountProduct.length}}</span> Product Found of <span></span></p>
                                </div>
                        ...
                        <div class="shop-product-content tab-content">
                            ...
                            <div id="grid-sidebar1" class="tab-pane fade active show">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-xl-3" v-for="product in getDiscountProduct" :key="product.id">
                            ...
                            <div id="grid-sidebar2" class="tab-pane fade">
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 col-xl-6" v-for="product in getDiscountProduct" :key="product.id">
...
export default {
    ...
    computed:{
     ...
     methods:{
        showDiscountProduct(){
        this.$store.dispatch('showDiscountProduct',this.$route.params.id)
        },
        addToCart(id){
        console.log(id)
